...
gl::Texture encodePoints( const vector<Vec2f> &points, int width, int height )
{
...
ci::Surface32f calcDiscreteVoronoiGpu( const std::vector<ci::Vec2f> &points, int width, int height )
{
...
ci::Channel32f calcDistanceMapGpu( const vector<Vec2f> &points, int width, int height )
{
	static gl::GlslProg voronoiShader( vertexShaderGlsl, voronoiShaderGlsl );
